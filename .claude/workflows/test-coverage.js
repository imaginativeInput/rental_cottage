...
const TARGETS = [
  ...
  },
  {
    ...
    brief: `STATIC, template-only (no <script>): <footer id="kontakt">. Contains: a phone link <a class="phone-link" href="tel:+48692434000"> with <span class="phone-number">+48 692 434 000</span>; an email link <a class="email-link" href="mailto:rzepiskadomek@gmail.com"> with <span class="email-text">rzepiskadomek@gmail.com</span>; a <div class="social-links"> with <a class="social-item google" target="_blank" rel="noopener noreferrer"> (href contains 'google.com/maps') and <a class="social-item instagram" target="_blank" rel="noopener noreferrer"> (href contains 'instagram.com/domekpanoramarzepiska'). The Facebook link is commented out. Cover: footer id 'kontakt'; phone-link href === 'tel:+48692434000' and phone-number text === '+48 692 434 000'; email-link href === 'mailto:rzepiskadomek@gmail.com'; exactly 2 .social-item; the google link href contains 'google.com/maps' with target==='_blank' and rel includes 'noopener'; the instagram link href contains 'instagram.com'. No pinia, no RouterLink, no i18n, no year.`,
  },
  {
